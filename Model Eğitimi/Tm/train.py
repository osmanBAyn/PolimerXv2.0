...
dataset = load_dataset(repo_id, split="Tm")
...
print("\n" + "="*40)
print("TÜM MODELLERİN PERFORMANS TABLOSU")
print("="*40)
print(results_df)
print("="*40)
...
plt.xlabel('Gerçek Tm Değerleri', fontsize=20)
plt.ylabel('Tahmin Edilen Tm Değerleri', fontsize=20)
plt.legend()
